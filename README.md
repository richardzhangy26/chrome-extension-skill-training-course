...
**👉 [点击下载最新版本 v0.8.0](https://gitee.com/richardzhangy26/chrome-extension-skill-training-course/releases/tag/v0.8.0)**
...
1. [下载 ZIP 文件](https://gitee.com/richardzhangy26/chrome-extension-skill-training-course/releases/tag/v0.8.0)
...
1. 点击多角色并行 按钮
2. 选择要并行运行的学生档位
3. 系统会自动创建多个角色标签页，每个标签页对应一个学生档位 （可以自定义添加）
4. 可以在每个标签页中独立进行对话交互
...
4. 知识库字段提供参考材料，帮助 AI 生成更贴合场景的回复
