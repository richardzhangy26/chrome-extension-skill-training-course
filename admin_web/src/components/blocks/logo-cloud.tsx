import { IconBrandChrome, IconBrandEdge, IconBrandFirefox } from '@tabler/icons-react';

import { FEATURED_MODEL_BRAND_ICONS } from '@/components/blocks/model-brand-icons';
...
const BROWSER_CHIPS = [
  {
    name: 'Chrome',
    icon: <IconBrandChrome aria-hidden="true" className="size-[17px] shrink-0" color="#4285F4" stroke={1.8} />,
  },
  {
    name: 'Edge',
    icon: <IconBrandEdge aria-hidden="true" className="size-[17px] shrink-0" color="#0AA4F6" stroke={1.8} />,
  },
  {
    name: 'Brave',
    icon: <BraveIcon className="size-[17px] shrink-0 text-[#FB542B]" />,
  },
  {
    name: 'Firefox',
    icon: <IconBrandFirefox aria-hidden="true" className="size-[17px] shrink-0" color="#FF7139" stroke={1.8} />,
  },
];
...
const LogoCloudSection = () => {
  const chips = [
    ...BROWSER_CHIPS,
    ...FEATURED_MODEL_BRAND_ICONS.map(({ Icon, iconClassName, label }) => ({
      name: label,
      icon: <Icon aria-hidden="true" className={cn('shrink-0', iconClassName)} size={17} />,
    })),
  ];
